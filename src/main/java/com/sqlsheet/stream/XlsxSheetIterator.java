...
public class XlsxSheetIterator extends AbstractXlsSheetIterator {
    ...
    class XSSFSheetEventHandler {
        ...
        public void startElement(final StartElement startElement) {
            final Map<String, String> attributes         = new HashMap<String, String>();
            final Iterator<?>         attributesIterator = startElement.getAttributes();
            while (attributesIterator.hasNext()) {
                final Attribute attr = (Attribute) attributesIterator.next();
